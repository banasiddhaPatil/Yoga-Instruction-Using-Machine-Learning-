...
class login_system:
    ...
    # Create Widgets
        ...
        self.bg1_icon=ImageTk.PhotoImage(file=r"D:/yoga_pose_detection/L.jpg")

        self.bg_icon=ImageTk.PhotoImage(file=r"D:/yoga_pose_detection/L.jpg")
        self.user_icon=ImageTk.PhotoImage(file=r"D:/yoga_pose_detection/u1.png")
        self.pass_icon=ImageTk.PhotoImage(file=r"D:/yoga_pose_detection/p1.jpg")
